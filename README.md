...
Ve a la pestaña de **[Releases](https://github.com/jgelvez/cpu-j/releases/tag/v1.0.1)** en este repositorio y descarga el archivo correspondiente a tu sistema operativo:
